local material = require("doom-material.colors")
...
theme.loadEditor = function ()
	...
	local editor = {
		...
		EndOfBuffer =			{ fg = material.bg }, -- ~ lines at the end of a buffer
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        DashboardShortcut = { fg = material.orange},
        DashboardFooter = { fg = material.comments},
    }
