local hsluv = require("doom-tokyonight.hsluv")
...
function util.debug(colors)
  colors = colors or require("doom-tokyonight.colors")
  -- Dump unused colors
...
function util.autocmds(config)
  vim.cmd([[augroup TokyoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("doom-tokyonight.util").onColorScheme()]])
  if config.dev then
...
function util.load(theme)
  ...
  vim.g.colors_name = "doom-tokyonight"
