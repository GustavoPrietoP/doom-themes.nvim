...
if o.bg == 'dark' then
	colors = require('doom-solarized.solarized-normal.solarized-dark').setup()
else
	colors = require('doom-solarized.solarized-normal.solarized-light').setup()
end
