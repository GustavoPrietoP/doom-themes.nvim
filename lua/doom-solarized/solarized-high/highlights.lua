...
if o.bg == 'dark' then
	colors = require('doom-solarized.solarized-high.solarized-dark').setup()
else
	colors = require('doom-solarized.solarized-high.solarized-light').setup()
end
...
g.colors_name = 'doom-solarized-high'
