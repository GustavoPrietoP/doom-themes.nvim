...
let g:colors_name = 'doom-miramare'
" }}}
" Configuration: {{{
let s:configuration = {}
...
call s:HL('TabLineSel', s:palette.bg0, s:palette.bg1)
...
hi DashboardHeader guifg = #5b5b5b
hi DashboardCenter guifg = #e68183
hi DashboardShortcut guifg = #d3a0bc
hi DashboardFooter guifg = #5b5b5b
