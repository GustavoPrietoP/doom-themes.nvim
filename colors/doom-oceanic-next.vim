...
" {{{ Setup
  ...
  let g:colors_name="doom-oceanic-next"
" }}}
" {{{ Italics
...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('LspDiagnosticsUnderlineInformation', s:blue,       '',       'undercurl', '')

  call s:hi('LspDiagnosticsDefaultHint',          s:cyan,       '',       '',          '')
  call s:hi('LspDiagnosticsSignHint',             s:cyan,   '',       '',          '')
  call s:hi('LspDiagnosticsUnderlineHint',        s:cyan,       '',       'undercurl', '')
...
hi! DashboardHeader guifg = #65737e
hi! DashboardCenter guifg = #c594c5
hi! DashboardShortcut guifg =#f99157
hi! DashboardFooter guifg = #65737e
