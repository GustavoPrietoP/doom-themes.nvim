...
let g:colors_name = "doom-ayu-light"
"}}}
...
let s:palette.bg        = {'dark': "#0F1419",  'light': "#FAFAFA",  'mirage': "#161b25s"}
...
exe "hi! ErrorMsg"      .s:fg_error       .s:bg_none        .s:fmt_stnd
...
hi! WhichKeyFloat guibg=#fbfbfa
hi! WhichKeyGroup guifg=#d4bfff

"Dashboard
hi! DashboardHeader guifg = #5c6773
hi! DashboardCenter guifg = #FFAE57
hi! DashboardShortcut guifg = #d4bfff
hi! DashboardFooter guifg = #5c6773
