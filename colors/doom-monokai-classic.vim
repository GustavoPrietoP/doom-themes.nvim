...
let colors_name = "doom-monokai-classic"
...
let s:cursorline  = { "gui": "#1c1f19", "cterm": "NONE"}
...
call s:h("VertSplit",     { "fg": s:lightblack})
...
" Whickey
hi WhichKey guifg=#A6E22D
hi WhichKeySeparator guifg=#2D2E27
hi WhichKeyDesc guifg=#246b9c
hi WhichKeyValue guifg=#246b9c
hi WhichKeyFloat guibg=#1c1f19
hi WhichKeyGroup guifg=#ae81ff
...
hi DashboardCenter guifg = #e73c50
hi DashboardShortcut guifg = #ae81ff
